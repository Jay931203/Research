...
export default function Chapter5Page() {
  ...
  const handleNavigate = useCallback((id: string) => {
    ...
    if (el) {
      ...
      el.classList.add('ring-2', 'ring-purple-400', 'ring-offset-4');
      setTimeout(() => {
        el.classList.remove('ring-2', 'ring-purple-400', 'ring-offset-4');
      }, 2000);
    }
  }, []);
        ...
        <aside className="hidden lg:block w-64 shrink-0">
          <div className="sticky top-16 pt-8 pb-8 pr-4 max-h-[calc(100vh-4rem)] overflow-y-auto">
            ...
            <div className="mt-6 px-3">
              <div className="text-xs text-slate-400 mb-1">{Math.round(scrollProgress)}% complete</div>
